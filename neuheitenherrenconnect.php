...
<body>
	...
	<div class="menuschuh">
		<div>
			<ul>
				<li><a href="nadidashconnect.php"><img src="img/1.jpg"width="20">
				Adidas</a></li>
				<li><a href="nnikehconnect.php"><img src="img/2.jpg"width="28">Nike</a></li>
				<li><a href="npumahconnect.php"><img src="img/3.jpg"width="20">Puma</a></li>
				<li><a href="nfilahconnect.php"><img src="img/4.jpg"width="30">Fils</a></li>
			</ul>
	...
	$sql1 = "SELECT * FROM Schuh WHERE Kategorie= 'Herren' AND Status= 'Neuheiten' ";
