...
<body>
	...
	<div class="menuschuh">
		<div>
			<ul>
				<li><a href="sadidashconnect.php"><img src="img/1.jpg"width="20">
				Adidas</a></li>
				<li><a href="snikehconnect.php"><img src="img/2.jpg"width="28">Nike</a></li>
				<li><a href="spumahconnect.php"><img src="img/3.jpg"width="20">Puma</a></li>
				<li><a href="sfilahconnect.php"><img src="img/4.jpg"width="30">Fils</a></li>
	...
	$sql1 = "SELECT * FROM Schuh WHERE Kategorie= 'Herren' AND Status= 'Sale' ";
