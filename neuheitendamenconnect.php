...
<body>
	...
	<div class="menuschuh">
		<div>
			<ul>
				<li><a href="nadidasdconnect.php"><img src="img/1.jpg"width="20">
				Adidas</a></li>
				<li><a href="nnikedconnect.php"><img src="img/2.jpg"width="28">Nike</a></li>
				<li><a href="npumadconnect.php"><img src="img/3.jpg"width="20">Puma</a></li>
				<li><a href="nfiladconnect.php"><img src="img/4.jpg"width="30">Fils</a></li>
			</ul>
