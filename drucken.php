...
<?php
	if(isset($_GET['action'])){
		...
		if($_GET['action']=='print'){
			...
			$select = "SELECT * FROM Bestellung ,Ist_für, Schuh, KundeKF WHERE Bestellung.BestellungID=Ist_für.BestellungID AND Ist_für.BestellungID=$bid AND Schuh.Schuhnr= Ist_für.Schuhnr AND KundeKF.KundeID = Bestellung.KundeID ";
